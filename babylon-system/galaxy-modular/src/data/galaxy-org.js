...
// --- GLIESE 1061 (confirmados) ---
		...
		"Gliese 1061 c": {
			...
			orbitalPeriod: 6.689,
			inclination: 0.5,
			argumentOfPeriapsis: 88.0,
			longitudeOfAscendingNode: 50.0,
			lastPerihelion: "2024-01-01",
			rotationAxis: { x: 0, y: 1, z: 0 },
			axialTilt: 2.0,
			rotationPeriod: 6.689,
			kind: "planet",
			radius: 1.95
		},
...
// --- YZ CETI (confirmados; se usa la solución compacta clásica del sistema) ---
		...
		"YZ Ceti d": {
			...
			color: 0x7a7065,
			orbits: "YZ Ceti",
			orbitalPeriod: 4.65626,
			inclination: 0.8,
			argumentOfPeriapsis: 200.0,
			longitudeOfAscendingNode: 65.0,
			lastPerihelion: "2024-01-01",
			rotationAxis: { x: 0, y: 1, z: 0 },
			axialTilt: 2.0,
			rotationPeriod: 4.65626,
			kind: "planet",
			radius: 1.75
		},
...
// --- TEEGARDEN'S STAR (confirmados) ---
		...
		"Teegarden's Star b": {
			...
			orbitalPeriod: 4.90634,
			inclination: 0.5,
			argumentOfPeriapsis: 338.0,
			longitudeOfAscendingNode: 25.0,
			lastPerihelion: "2024-01-01",
			rotationAxis: { x: 0, y: 1, z: 0 },
			axialTilt: 0.0,
			rotationPeriod: 4.90634,
			kind: "planet",
			radius: 1.9
		},
		...
		"Teegarden's Star d": {
			...
			orbitalPeriod: 26.13,
			inclination: 1.0,
			argumentOfPeriapsis: 345.0,
			longitudeOfAscendingNode: 85.0,
			lastPerihelion: "2024-01-01",
			rotationAxis: { x: 0, y: 1, z: 0 },
			axialTilt: 5.0,
			rotationPeriod: 26.13,
			kind: "planet",
			radius: 1.7
		},
